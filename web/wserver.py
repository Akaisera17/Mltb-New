    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/faishalk">
          <h2 class="name">Qbittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/Akaisera17/Mltb-New"><i class="fab fa-github"></i></a>
        <a href="https://t.me/faishalk"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
...
@app.route('/')
def homepage():
    return "<h1>See Window_Mirror_Bot <a href='https://github.com/Dawn-India/Z-Mirror'>@GitHub</a> By <a href='https://github.com/Dawn-India'>Dawn In</a></h1>"
